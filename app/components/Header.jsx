...
const Header = () => {
    ...
    return (
        <>
            ...
            <nav className="md:hidden w-full mx-auto p-4">
                {!isModalVisible &&
                    <div className="z-0 flex flex-wrap items-center justify-between ">
                        <HeaderName />
                        <svg onClick={() => (setIsModalVisible(true))} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                {isModalVisible &&
                    ...
                    <div className="z-2 w-full h-fit ">
                        <div className=" flex flex-wrap items-center justify-between">

                            <HeaderName />
                            <svg onClick={()=> (setIsModalVisible(false))} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
