...
const Contact = () => {
    return (
        <>
            <div id='contacts' className='flex flex-col gap-4 sm:flex-row justify-between items-center'>
                <p className='w-full md:w-[505px] text-[#ABB2BF] font-medium text-[16px]'>I’m open to work. If you have a request or question, don’t hesitate to contact me !!</p>
                <div className=' w-full md:w-auto flex flex-col gap-4 border border-[#ABB2BF] p-4'>
