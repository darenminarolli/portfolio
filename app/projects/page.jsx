    ...
    return (
        <section className='w-full py-12'>
            ...
            <div className="mt-14 grid grid-cols-1 md:grid-cols-3  items-start gap-y-8 md:gap-4 ">
                ...
                <Cart source={BarberImg} title={'Barber Shop'} endpoint={'https://barbershop-livid.vercel.app/'} tech={'React Next Tailwind'} />
                ...
                <Cart  source={Dentist} title={'Node, Express Crud App'} endpoint={'https://github.com/darenminarolli/Crud-Node-App'} tech={'Node.js Express.js MongoDB Mongoose'}/>
            </div>
        </section>
    )
}
